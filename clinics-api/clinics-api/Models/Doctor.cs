    ...
    public class Doctor
    {
        ...
        public static explicit operator Doctor(RegesterDoctorUserDto app)
        {
            return new Doctor
            {
                ...
                OpeningTime=SharedMethods.RoundToNearestQuarterHour(TimeSpan.Parse(app.OpeningTime)),
                CloseTime = SharedMethods.RoundToNearestQuarterHour(TimeSpan.Parse(app.CloseTime)),
