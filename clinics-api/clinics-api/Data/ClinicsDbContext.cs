    ...
    public class ClinicsDbContext: IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           .HasForeignKey<Doctor>(Doctor => Doctor.UserId);
            ...
            //doctorUser
            var docUser1 = new ApplicationUser
            {
                Id = "2",
            ...
            docUser1.PasswordHash = hasher.HashPassword(docUser1, "Ahmad@123");
            modelBuilder.Entity<ApplicationUser>().HasData(docUser1);
            modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            new IdentityUserRole<string>
            {
                RoleId = "doctor",
            ...
            var docUser2 = new ApplicationUser
            {
                Id = "3",
                UserName = "Rana",
            ...
            docUser2.PasswordHash = hasher.HashPassword(docUser2, "Rana@123");
            modelBuilder.Entity<ApplicationUser>().HasData(docUser2);
            modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            new IdentityUserRole<string>
            {
                RoleId = "doctor",
            ...
            var docUser3 = new ApplicationUser
            {
                Id = "4",
                UserName = "Omar",
            ...
            docUser3.PasswordHash = hasher.HashPassword(docUser3, "Omar@123");
            modelBuilder.Entity<ApplicationUser>().HasData(docUser3);
            modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            new IdentityUserRole<string>
            {
                RoleId = "doctor",
